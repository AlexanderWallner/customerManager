        ...
        'elements' => array(
          ...
          'customer' => array(
                ...
                'field' => array(
                    ...
                    'values' => isset($search['customer_id'])?$search['customer_id']:'',
                    'options' => $c,
                    'blank' => _l(' - Cutomer - '),
...
if(module_config::c('finance_list_show_totals',1)){
    ...
    foreach($finance_credit_total + $finance_debit_total as $currency_id => $foo){
        ...
        $footer_rows[] = array(
            ...
            'sort_account' => array(
                'data' => '<strong>'.dollar(isset($finance_debit_total[$currency_id]) ? $finance_credit_total[$currency_id] - $finance_debit_total[$currency_id] : 0,true,$currency_id).'</strong>',
                'cell_colspan' => 4
            ),
        );
    }
