...
<script type="text/javascript">
    ...
    $(function(){
		$("#calendar_event_popup").dialog({
			...
			open: function(){
                ...
                var testing = function () {$('.dropdown-select2').select2({allowClear: true, width: 200});}
                setTimeout(function () {testing(); setTimeout(function () {testing();}, 1000);}, 1000);
			},
			close: function() {
	...
	/// set auto refresh every 60 sec
	setInterval(function()	{	$("#gridcontainer").reload();	}, 300000);
</script>
