...
/** 
  ...
  * Package Date: 2015-03-01 09:09:51 
  * IP Address: 185.17.207.124
  */
...
//            $sql .=  " AND (sc.`deleted` = 0 OR sc.`deleted` IS NULL)";
	...
	public static function hook_filter_var_invoice_email_template($callback, $invoice_id, $invoice_data, $template_name){
