    ...
    <table border="0" cellspacing="0" cellpadding="2" class="tableclass tableclass_form tableclass_full">
        <tbody>
            <tr>
                ...
                <td>
                    <input type="text" class="update-name-field" data-id="<?php echo date('d.m.Y') . ' ' . $jobIncrement; ?>" name="name" id="job_name" value="<?php echo htmlspecialchars($job['name']); ?>" />
                </td>
            </tr>
            <tr hidden = "true">
                <th>
            ...
            <tbody>
                ...
                <tr hidden="true">
		            ...
		            <tr hidden="true">
		                ...
		                <td>
		                    <?php echo print_select_box(array(1=>_l('After Tax')),'discount_type',$job['discount_type']);?>
		                </td>
		            </tr>
                    <?php
                    if(class_exists('module_extra',false) && module_extra::is_plugin_enabled()){
...
$header['button'][] = array(
        ...
        <table border="0" cellspacing="0" cellpadding="2" class="tableclass tableclass_rows tableclass_full">
            ...
            <tr>
                ...
                <td align="center" valign="top">
                    ...
                    <input type="hidden" name="job_task[new][expense_t]" value="1">
                    <input type="hidden" name="job_task[new][expense]" value="1" id="expense_t_new">
                    <input type="hidden" name="job_task[new][fee_t]" value="1">
                    <input type="hidden" name="job_task[new][fee]" value="1" id="fee_t_new">
 ...
 <input type="hidden" name="job_task[new<?php echo $task_number;?>][expense_t]" value="1">
 <input type="hidden" name="job_task[new<?php echo $task_number;?>][fee_t]" value="1">
...
<input type="hidden" name="job_task[new<?php echo $task_number;?>][expense]" value="<?php echo htmlspecialchars($task_data['expense']);?>">
<input type="hidden" name="job_task[new<?php echo $task_number;?>][fee]" value="<?php echo htmlspecialchars($task_data['fee']);?>">
