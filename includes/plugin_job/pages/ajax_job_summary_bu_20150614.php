    ...
    <tr>
        ...
        <tr>
            ...
            <span  <span class="currency error_text" style="text-decoration: underline; font-weight: bold;">
                <?php echo dollar($job['total_net_amount']-$job['total_amount_invoiced'],true,$job['currency_id']); // $job['total_amount_invoiced_deposit'] ?>
            </span>
                <?php if(isset($job['total_amount_invoiced_deposit']) && $job['total_amount_invoiced_deposit'] > 0){ ?>
                    <br/>
                    <span  <span class="currency error_text" style="text-decoration: underline; font-weight: bold;">
                (<?php echo dollar($job['total_net_amount']-$job['total_amount_invoiced_deposit'],true,$job['currency_id']);?> <?php _e('deposit');?>)
            </span>
                <?php } ?>
            </td>
            <td>
