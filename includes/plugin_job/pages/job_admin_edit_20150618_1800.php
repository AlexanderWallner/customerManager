...
<script type="text/javascript">
 ...
 function lock_job(job_id, this){
         $('.show.job').hide(); $('#butt_del').show();
        if(confirm('<?php _e('Really lock this job?');?>') && job_id){
             var $this = $(this);
    ...
    if ($this.is(':checked')) {
        ...
        job_lock ==0;
            ...
            $.ajax({
                url: '<?php echo module_job::link_ajax_task($job_id,false); ?>',
                data: {job_id:job_id, job_lock:job_lock},
                type: 'POST',
                dataType: 'text',
                success: function(r){
