...
$table_invoices = module_invoice::get_invoice_med_items($invoice_id,$invoice);
...
foreach(module_invoice::get_invoice_med_items($invoice_id,$invoice) as $invoice_item_id => $invoice_item_data){
