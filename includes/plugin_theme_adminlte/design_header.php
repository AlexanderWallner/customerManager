...
switch($display_mode){
    ...
    <body class="<?php echo module_theme::get_config( 'adminlte_colorstyle', 'dark' ) == 'light' ? 'skin-blue' : 'skin-black';?> fixed"  id="<?php echo isset( $page_unique_id ) ? $page_unique_id : 'page'; ?>" <?php if ( $display_mode == 'iframe' ) {
			    ...
			    <div class="navbar-right">
				    ...
				    <?php if ( module_security::is_logged_in() ) { ?>
					    <ul class="nav navbar-nav">
						    ...
						    <?php if ( class_exists( 'module_job', false ) && module_job::can_i( 'view', 'Jobs' ) ) {
						    ...
						    <li class="dropdown user user-menu">
							    ...
							    <ul class="dropdown-menu">
								    ...
								    <li class="user-header bg-teal">
									    ...
									    <small><?php echo _l( '%s %s %s %s', _l( date( 'D' ) ), date( 'j' ),  _l( date( 'F' ) ), date( 'Y' ) ); ?></small>
								    </li>
								    <!-- Menu Footer-->
			    ...
			    <section class="sidebar">
				    ...
				    <div class="user-panel">
					    ...
					    <div class="pull-left info">
                            ...
                            <p>
                                <a href="<?php echo module_user::link_open( module_security::get_loggedin_id() ); ?>">
                                    <i class="fa fa-user"></i> <?php _e( htmlspecialchars( $user['name'] ) ); ?>
                                </a>
                            </p>
						    <a href="#"><i
								    class="fa fa-calendar"></i> <?php echo _l( '%s %s %s %s', _l( date( 'D' ) ), date( 'j' ), _l( date( 'F' ) ), date( 'Y' ) ); ?>
						    </a>
					    </div>
				    </div>
