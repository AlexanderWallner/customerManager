        ...
        'elements' => array(
            'name' => array(
                ...
                'field' => array(
                    ...
                    'name' => 'name',
                    'value' => $quote['name'],
	                'data-id' => date('d.m.Y') . ' ' . $quoteIncrement,
   ...
   //Wallner 2015-03-15
    ...
    foreach($quote['taxes'] as $id=>$tax){  ?>
        <div class="dynamic_block">
            ...
            <a type="hidden" href="#" class="add_addit" onclick="seladd(this); ucm.quote.update_quote_tax(); return false;"></a>
            <a type="hidden" href="#" class="remove_addit" onclick="selrem(this); ucm.quote.update_quote_tax(); return false;">-</a>
        </div>
    <?php } ?>
    </div>
    <script type="text/javascript">
		    ...
		    $fieldset_data['elements'][] = array(
			    ...
			    'fields' => array(
				    function () use ( &$quote ) {
					    ...
					    echo print_select_box( $c, 'customer_id', $quote['customer_id'], 'change-name-field dropdown-select2', true, false, false, array('customer-data' => $data) );
    ...
    hook_handle_callback('layout_column_half',2,'65');
                ...
                if(module_quote::can_i('edit','Quote Tasks')||module_quote::can_i('view','Quote Tasks')){
                    ...
                    $header['button'][] = array(
                          ...
                          'onclick' => "window.open('http://waw-it.com/?m[0]=config&p[0]=config_admin&m[1]=product&p[1]=product_settings&m[2]=product&p[2]=product_admin&product_id=new','popup','scrollbars=yes, width=460, height=670'); return false;",
                    ...
                    <table border="0" cellspacing="0" cellpadding="2" class="tableclass tableclass_rows tableclass_full" id="quote_task_listing">
                        ...
                        <tr>
                         ...
                         <!-- Wallner was changed from -1 to 1 Overall in Job and invoice -->       
